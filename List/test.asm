...
; 0000 0015 
; 0000 0016 
; 0000 0017     else if(flag==0 && LED==LED4)
	CLR  R0
	CP   R0,R8
	CPC  R0,R9
	BRNE _0x6
...
_main:
; 0000 0037 
; 0000 0038 EICRA=0b00001010;
	LDI  R30,LOW(10)
	STS  106,R30
; 0000 0039 EICRB=0x00;
	LDI  R30,LOW(0)
	OUT  0x3A,R30
; 0000 003A EIMSK=0x03;
	LDI  R30,LOW(3)
	OUT  0x39,R30
; 0000 003B EIFR=0x03;
	OUT  0x38,R30
...
; 0000 0048     {
; 0000 0049 
; 0000 004A         PORTF=0xff;
	LDI  R30,LOW(255)
	STS  98,R30
; 0000 004B         LED_ON(LED);
	ST   -Y,R5
	ST   -Y,R4
	RCALL _LED_ON
...
; 0000 0050 
; 0000 0051     }
; 0000 0052     LED_ON(LED);
_0xC:
	ST   -Y,R5
	ST   -Y,R4
	RCALL _LED_ON
; 0000 0053     PORTF=0xff;
	LDI  R30,LOW(255)
	STS  98,R30
; 0000 0054 
; 0000 0055 
